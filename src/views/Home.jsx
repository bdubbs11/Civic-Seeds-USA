...
return (
    <div className="flex flex-col flex-1 min-h-screen justify-center items-center">
      ...
      {/* who we are section */}
      <div className="container grid grid-cols-1 md:grid-cols-16 min-w-screen mx-auto bg-violet-700">
        <div className="col-start-2 col-span-14">
          <div className="flex md:flex-row flex-col justify-center items-center text-white py-10">
            ...
            <div className="flex flex-col w-full h-full px-10 md:px-0 text-center md:text-left mt-10 md:mt-0 md:mr-20 order-2">
              ...
              <button className="bg-white text-violet-700 px-2 py-4 rounded-full w-1/2 mt-10 mx-auto md:mx-0 hover:bg-slate-100 ease-in-out duration-300 cursor-pointer transition-transform hover:scale-[1.02]">Learn More</button>
            </div> 
          </div>
        </div>
      </div>
      ...
      <div className="container grid grid-cols-1 md:grid-cols-16 min-w-screen mx-auto">
        ...
        <h1 className="text-2xl md:text-4xl font-bold mb-4 text-black capitalize my-10"> Working with Deitra</h1>
          <div className="flex flex-col md:flex-row justify-center items-center py-5 md:py-10 gap-3 md:gap-5 px-10 md:px-0">
            <Link to="/schedule-services">  
              <div className="flex flex-col w-full h-full text-center hover:bg-slate-100 p-4 rounded-lg ease-in-out duration-300">
                <h1 className="text-xl md:text-2xl font-bold mb-4">Coaching</h1>
                <p className="text-base md:text-lg">I help parents create a strong foundation for their children to grow into powerful citizens. I offer one-on-one coaching sessions to help parents develop the skills they need to raise their children to be strong, responsible citizens. </p>
              </div>
            </Link>

            <Link to="/schedule-services">  
              <div className="flex flex-col w-full h-full text-center hover:bg-slate-100 p-4 rounded-lg ease-in-out duration-300">
                <h1 className="text-xl md:text-2xl font-bold mb-4">Workshops</h1>
                <p className="text-base md:text-lg">I lead interactive workshops that give parents concrete tools for nurturing character, leadership, and civic awareness at home. These group sessions offer hands-on learning, real-life examples, and a supportive community of parents working toward the same goal.</p>
              </div>
            </Link>

            <Link to="/schedule-services">  
              <div className="flex flex-col w-full h-full text-center hover:bg-slate-100 p-4 rounded-lg ease-in-out duration-300">
                <h1 className="text-xl md:text-2xl font-bold mb-4">Speaking Engagements</h1>
                <p className="text-base md:text-lg">I speak to schools, faith communities, nonprofits, and parent groups about the power families hold in shaping strong children and strong communities. My talks blend storytelling, research, and practical guidance—offering audiences inspiration and clear next steps they can use right away.</p>
              </div>
            </Link>
          </div>
        </div>
