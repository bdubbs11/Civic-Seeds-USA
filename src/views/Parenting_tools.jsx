    ...
    <div className="w-full">
      ...
      <section className="w-full bg-gray-50 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-violet-700 font-semibold text-xl mb-8 text-center md:text-left">
            Resources & Websites
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Civic Education */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-2xl font-bold text-violet-900 mb-3">Civic Education</h3>
              ...
              <a
                ...
                className="w-full bg-violet-700 text-white px-6 py-3 rounded-full hover:bg-violet-800 transition-colors duration-300 inline-block text-center"
              >
                Visit Site
              </a>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-2xl font-bold text-violet-900 mb-3">Constitution 101 Curriculum</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-2xl font-bold text-violet-900 mb-3">Teaching American History</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-2xl font-bold text-violet-900 mb-3">Learning for Justice</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
      ...
      <section className="w-full bg-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Indivisible */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-2xl font-bold text-violet-900 mb-3">Indivisible</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
            ...
            {/* NAACP */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-2xl font-bold text-violet-900 mb-3">NAACP</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
            ...
            {/* One Million Rising */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-2xl font-bold text-violet-900 mb-3">One Million Rising</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
      ...
      <section className="w-full bg-gray-50 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-2xl font-bold text-violet-900 mb-3">Center for American Progress</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
            ...
            {/* NPR */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-2xl font-bold text-violet-900 mb-3">NPR</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
      ...
      <section className="w-full bg-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Sankofa Kids Club */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-2xl font-bold text-violet-900 mb-3">Sankofa Kids Club</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
      ...
      <section className="w-full bg-gray-50 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Kairos Center */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-2xl font-bold text-violet-900 mb-3">Kairos Center</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
            ...
            {/* Sojourners */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-2xl font-bold text-violet-900 mb-3">Sojourners</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
      ...
      <section className="w-full bg-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* BabyCenter */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-2xl font-bold text-violet-900 mb-3">BabyCenter</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
