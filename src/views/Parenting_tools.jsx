    ...
    <div className="w-full">
      ...
      <section className="w-full bg-red-500 text-white py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Parenting Tools & Resources</h1>
      ...
      {/* Resources & Websites */}
      <section className="w-full py-16 px-4 -mb-10 md:mb-0">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-lg md:text-2xl font-bold text-red-500 mb-3">Civic Education</h3>
              ...
              <a
                ...
                className="w-1/2 mx-auto bg-red-500 text-white px-6 py-3 rounded-full text-sm md:text-base hover:bg-red-700 duration-300 inline-block text-center"
              >
                Visit Site
              </a>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-lg md:text-2xl font-bold text-red-500 mb-3">Constitution 101 Curriculum</h3>
              <p className="text-sm md:text-base text-black mb-4 leading-relaxed">
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-lg md:text-2xl font-bold text-red-500 mb-3">Teaching American History</h3>
              <p className="text-sm md:text-base text-black mb-4 leading-relaxed">
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-lg md:text-2xl font-bold text-red-500 mb-3">Learning for Justice</h3>
              <p className="text-sm md:text-base text-black mb-4 leading-relaxed">
      ...
      {/* Take Action */}
      <section className="w-full bg-white py-16 px-4 -mb-10 md:mb-0">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-red-500 font-semibold text-xl mb-8 text-center md:text-left">
            Take Action
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Indivisible */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-lg md:text-2xl font-bold text-red-500 mb-3">Indivisible</h3>
              <p className="text-sm md:text-base text-black mb-4 leading-relaxed">
            ...
            {/* NAACP */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-lg md:text-2xl font-bold text-red-500 mb-3">NAACP</h3>
              <p className="text-sm md:text-base text-black mb-4 leading-relaxed">
            ...
            {/* One Million Rising */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-lg md:text-2xl font-bold text-red-500 mb-3">One Million Rising</h3>
              <p className="text-sm md:text-base text-black mb-4 leading-relaxed">
      ...
      <section className="w-full py-16 px-4 -mb-10 md:mb-0">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-lg md:text-2xl font-bold text-red-500 mb-3">Center for American Progress</h3>
              <p className="text-sm md:text-base text-black mb-4 leading-relaxed">
            ...
            {/* NPR */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-lg md:text-2xl font-bold text-red-500 mb-3">NPR</h3>
              <p className="text-sm md:text-base text-black mb-4 leading-relaxed">
      ...
      <section className="w-full bg-white py-16 px-4 -mb-10 md:mb-0">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Sankofa Kids Club */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-lg md:text-2xl font-bold text-red-500 mb-3">Sankofa Kids Club</h3>
              <p className="text-sm md:text-base text-black mb-4 leading-relaxed">
      ...
      <section className="w-full py-16 px-4 -mb-10 md:mb-0">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Kairos Center */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-lg md:text-2xl font-bold text-red-500 mb-3">Kairos Center</h3>
              <p className="text-sm md:text-base text-black mb-4 leading-relaxed">
            ...
            {/* Sojourners */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-lg md:text-2xl font-bold text-red-500 mb-3">Sojourners</h3>
              <p className="text-sm md:text-base text-black mb-4 leading-relaxed">
      ...
      <section className="w-full bg-white py-16 px-4 mb-0 md:mb-0">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-red-500 font-semibold text-xl mb-8 text-center md:text-left">
            Parenting & Child Development
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* BabyCenter */}
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-100">
              <h3 className="text-lg md:text-2xl font-bold text-red-500 mb-3">BabyCenter</h3>
              <p className="text-sm md:text-base text-black mb-4 leading-relaxed">
